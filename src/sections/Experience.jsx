      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-muted-foregroundanimate-fade-in animation-delay-200">
            A timeline of my professional journey—from building strong frontend foundations to growing as a React-focused developer, contributing to real-world products and continuously improving my skills.
          </p>
        </div>
